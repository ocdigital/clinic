<x-admin-layout>
                              ...
                              <tr>
                                  ...
                                  <td class="px-6 py-4 whitespace-nowrap text-right">
                                    <div class="flex justify-end items-center">
                                        ...
                                        <button type="button" class="px-4 py-2 bg-red-500 hover:bg-red-700 text-white rounded-md" onclick="openDeleteModal('{{ $permission->id }}')">Deletar</button>
                                    </div>
                                  </td>
                              </tr>
                          @endforeach
  ...
  <script>
      function openDeleteModal(permissionId) {
          ...
          deleteForm.action = "{{ route('admin.permissions.destroy', '') }}" + "/" + permissionId;
